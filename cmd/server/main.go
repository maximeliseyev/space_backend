...
func main() {
	...
	notificationService := service.NewNotificationService(notificationRepo, roomRepo, cfg)
	bookingService := service.NewBookingService(bookingRepo, roomRepo, userRepo, notificationService)
